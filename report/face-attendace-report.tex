...
\begin{enumerate}[Step 1.]
	...
	\item Identify the skew of the image: calculate the coordinate of these eyes and the angle deviation between two eyes in the horizontal direction.
	\item Identify the rotation of the image: defining of the midpoint of the face is the midpoint of the distance between the right and left eye.	
\end{enumerate}
If the nose is deviated from the midpoint of the face by more than 20 pixels or the deviation between the noise and the bound of the faces are larger than 20, we could ignore these conditions.\\
